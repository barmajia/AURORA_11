...
import 'package:aurora/presentation/auth/factories/signup.dart';
...
class _FactoryLoginPageState extends State<FactoryLoginPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Factory Login')),
      body: SafeArea(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text('Factory Login', textAlign: TextAlign.center, style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold)),
                const SizedBox(height: 8),
                Text('Sign in to your factory account', textAlign: TextAlign.center, style: TextStyle(fontSize: 16, color: Colors.grey[600])),
                const SizedBox(height: 40),
                TextFormField(
